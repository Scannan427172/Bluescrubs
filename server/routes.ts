      ...
      const testQuestions = [
        {
          ...
          answer: "A",
          explanation: "**Why Nitrofurantoin 100mg modified-release twice daily for 3 days is correct:**\n\n• **Gold Standard Treatment**: \n  Represents first-line therapy for uncomplicated lower UTIs in non-pregnant women aged 16-64, as established by current UK clinical guidelines\n\n• **Exceptional Efficacy**: \n  Demonstrates outstanding activity against common uropathogens, particularly Escherichia coli (80-85% of uncomplicated UTIs)\n\n• **Unique Mechanism**: \n  Multiple bacterial targets significantly reduce resistance development compared to other antibiotics\n\n• **Targeted Action**: \n  Achieves high urine concentrations with minimal systemic exposure, making it ideally suited for urinary tract infections\n\n• **Proven Results**: \n  Clinical trials consistently demonstrate cure rates exceeding 90% for uncomplicated cystitis\n\n• **Optimized Formulation**: \n  Modified-release ensures sustained therapeutic levels throughout dosing interval, optimizing bacterial eradication while minimizing GI side effects\n\n• **Low Resistance**: \n  UK surveillance data confirms excellent activity against common uropathogens, with resistance rates below 5% for E. coli\n\n• **Optimal Duration**: \n  Three-day course strikes perfect balance between therapeutic efficacy and minimizing unnecessary antibiotic exposure\n\n• **Antimicrobial Stewardship**: \n  Supports responsible prescribing principles while maintaining high cure rates\n\n• **Evidence-Based Choice**: \n  Aligns with current evidence-based medicine recommendations, considering both individual patient factors and broader public health implications regarding antibiotic resistance",
