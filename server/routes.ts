      ...
      const testQuestions = [
        {
          ...
          answer: "A",
          explanation: "**Why Nitrofurantoin 100mg modified-release twice daily for 3 days is correct:**\n\n• **Gold Standard Treatment**: \n  - First-line therapy for uncomplicated lower UTIs in non-pregnant women aged 16-64\n  - Established by current UK clinical guidelines\n  - Recommended across all major UK medical guidance sources\n\n• **Exceptional Efficacy**: \n  - Outstanding activity against common uropathogens\n  - Particularly effective against Escherichia coli (80-85% of uncomplicated UTIs)\n  - Maintains high cure rates in clinical practice\n\n• **Unique Mechanism**: \n  - Targets multiple bacterial processes simultaneously\n  - Significantly reduces resistance development compared to other antibiotics\n  - Multiple modes of action prevent bacterial adaptation\n\n• **Targeted Action**: \n  - Achieves high concentrations specifically in urine\n  - Minimal systemic exposure reduces side effects\n  - Ideally suited for urinary tract infections\n\n• **Proven Results**: \n  - Clinical trials demonstrate cure rates exceeding 90%\n  - Consistent efficacy across different patient populations\n  - Reliable treatment outcomes in uncomplicated cystitis\n\n• **Optimized Formulation**: \n  - Modified-release ensures sustained therapeutic levels\n  - Optimizes bacterial eradication throughout dosing interval\n  - Minimizes gastrointestinal side effects\n\n• **Low Resistance**: \n  - UK surveillance data shows resistance rates below 5% for E. coli\n  - Maintains clinical reliability over time\n  - Preserves effectiveness for future use\n\n• **Optimal Duration**: \n  - Three-day course strikes perfect balance\n  - Effective treatment while limiting unnecessary antibiotic exposure\n  - Supports antimicrobial stewardship principles\n\n• **Evidence-Based Choice**: \n  - Aligns with NICE and CKS recommendations\n  - Considers both individual patient factors and public health\n  - Balances efficacy with resistance prevention",
          incorrectExplanation: "• **Option B (Trimethoprim) - Not First-Line**: \n  - High resistance rates (20-30% for E. coli in UK)\n  - Relegated to second-line due to declining efficacy\n  - Should be reserved for culture-guided therapy\n\n• **Option C (Amoxicillin) - Poor UTI Coverage**: \n  - Inadequate activity against common uropathogens\n  - High resistance rates among E. coli strains\n  - Not recommended for empirical UTI treatment\n\n• **Option D (Ciprofloxacin) - Unnecessary Broad-Spectrum**: \n  - Reserved for complicated UTIs or specific indications\n  - Contributes to fluoroquinolone resistance\n  - Not appropriate for uncomplicated lower UTI\n\n• **Option E (Fosfomycin) - Second-Line Treatment**: \n  - Reserved for treatment failures or specific circumstances\n  - More expensive than first-line options\n  - Not recommended as initial empirical therapy",
