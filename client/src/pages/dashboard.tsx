      ...
      <section className="relative min-h-[400px] overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-white" style={{textShadow: '2px 2px 4px rgba(0,0,0,0.8), 0px 0px 8px rgba(0,0,0,0.6)'}}>
              Welcome back, {user.username.split(' ')[1]}!
            </h1>
            <p className="text-lg md:text-xl mb-2 text-white" style={{textShadow: '2px 2px 4px rgba(0,0,0,0.8), 0px 0px 8px rgba(0,0,0,0.6)'}}>
            ...
            <div className="flex justify-center gap-4 mt-8">
              <div className="bg-white/30 backdrop-blur-sm rounded-lg px-6 py-4 border border-white/50">
                <div className="flex items-center space-x-2 mb-1">
                  ...
                  <span className="text-sm font-medium text-white" style={{textShadow: '1px 1px 2px rgba(0,0,0,0.7)'}}>Day Streak</span>
                </div>
                <div className="text-2xl font-bold text-white" style={{textShadow: '2px 2px 4px rgba(0,0,0,0.8)'}}>{user.studyStreak}</div>
              </div>
              <div className="bg-white/30 backdrop-blur-sm rounded-lg px-6 py-4 border border-white/50">
                <div className="flex items-center space-x-2 mb-1">
                  <Award className="w-5 h-5 text-white" />
                  <span className="text-sm font-medium text-white" style={{textShadow: '1px 1px 2px rgba(0,0,0,0.7)'}}>Total Points</span>
                </div>
                <div className="text-2xl font-bold text-white" style={{textShadow: '2px 2px 4px rgba(0,0,0,0.8)'}}>{user.totalPoints.toLocaleString()}</div>
              </div>
              <div className="bg-white/30 backdrop-blur-sm rounded-lg px-6 py-4 border border-white/50">
                <div className="flex items-center space-x-2 mb-1">
                  <span className="text-2xl">📚</span>
                  <span className="text-sm font-medium text-white" style={{textShadow: '1px 1px 2px rgba(0,0,0,0.7)'}}>Questions Correct</span>
                </div>
                <div className="text-2xl font-bold text-white" style={{textShadow: '2px 2px 4px rgba(0,0,0,0.8)'}}>0</div>
              </div>
            </div>
