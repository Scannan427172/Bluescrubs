    ...
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="relative bg-gradient-to-r from-blue-600 to-purple-700 w-full h-96 md:h-[500px] lg:h-[550px] mb-8 overflow-hidden hero-banner">
          ...
          <div className="relative z-50 flex flex-col items-center justify-end pb-16 text-center px-4 sm:px-8 h-full hero-text" style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.8)' }}>
