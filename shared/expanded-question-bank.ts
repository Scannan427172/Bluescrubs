...
export const EXPANDED_QUESTION_BANK: GMCQuestion[] = [
...

  {
    ...
    correctAnswer: 1,
    explanation: "This 62-year-old patient presents with heart failure with reduced ejection fraction (HFrEF) six weeks post-myocardial infarction: breathlessness on minimal exertion, bilateral ankle swelling, ejection fraction 35%, and elevated BNP 850 pg/ml (normal <100 pg/ml). This clinical picture requires evidence-based neurohormonal blockade according to NICE CG108 and ESC Heart Failure Guidelines 2021.\n\nOption B is correct because ramipril (ACE inhibitor) plus bisoprolol (beta-blocker) provides proven mortality reduction in post-MI HFrEF. Ramipril should be started at 1.25mg daily and titrated to 10mg daily, blocking the renin-angiotensin-aldosterone system to reduce afterload, preload, and ventricular remodeling. The SAVE trial demonstrated 19% mortality reduction with ACE inhibitors post-MI. Bisoprolol should be introduced once stable on ACE inhibitor, starting at 1.25mg daily and titrating to 10mg daily. CIBIS-II trial showed 34% mortality reduction with bisoprolol in HFrEF, counteracting sympathetic activation and reducing arrhythmic risk.\n\nOption A is incorrect because furosemide 40mg alone only provides symptomatic relief from fluid overload without mortality benefit. While diuretics improve symptoms, they don't address the underlying neurohormonal activation.\n\nOption C is incorrect because atorvastatin 80mg and aspirin 75mg address secondary prevention but don't treat the heart failure syndrome. These are important but secondary to HFrEF-specific therapy.\n\nOption D is incorrect because amlodipine (calcium channel blocker) can worsen heart failure through negative inotropic effects. Bendroflumethiazide doesn't provide the proven mortality benefits of ACE inhibitors and beta-blockers.\n\nOption E is incorrect because this patient has clear symptomatic HFrEF requiring immediate treatment, not just monitoring.\n\nConcise Summary: Post-MI HFrEF with EF 35% and elevated BNP requires dual neurohormonal blockade with ramipril and bisoprolol for proven mortality reduction and symptom improvement.",
    learningObjectives: [
...

  {
    ...
    correctAnswer: 2,
    explanation: "This 68-year-old patient with established COPD presents with acute exacerbation: increased breathlessness, increased sputum volume, and purulent sputum production over 3 days. This clinical presentation meets all three Anthonisen criteria, indicating bacterial superinfection requiring specific antibiotic therapy according to NICE CG101 and GOLD 2023 guidelines.\n\nOption C is correct because prednisolone 30mg daily plus amoxicillin 500mg TDS provides dual therapy addressing both inflammatory and infective components. Prednisolone reduces airway inflammation, improving lung function and shortening recovery time by 1-2 days. The Niewoehner study demonstrated 50% reduction in treatment failure with oral corticosteroids. Amoxicillin covers common COPD pathogens: Haemophilus influenzae (40-50%), Streptococcus pneumoniae (25-30%), and Moraxella catarrhalis (15-20%). Meeting all three Anthonisen criteria indicates 70% bacterial isolation rate, justifying antibiotic use.\n\nOption A is incorrect because high-flow oxygen 15L/min risks CO2 retention in COPD patients due to loss of hypoxic respiratory drive. COPD patients should receive controlled oxygen targeting 88-92% saturation.\n\nOption B is incorrect because IV hydrocortisone 200mg is used for severe asthma exacerbations, not COPD. Oral prednisolone is preferred for COPD exacerbations and equally effective with better patient tolerance.\n\nOption D is incorrect because bronchodilators alone (salbutamol/ipratropium) inadequately address the bacterial infection component indicated by purulent sputum. Antibiotics are essential when all three Anthonisen criteria are met.\n\nOption E is incorrect because non-invasive ventilation is premature without arterial blood gas assessment showing respiratory acidosis (pH <7.35). This patient needs medical optimization first.\n\nConcise Summary: COPD exacerbation with all three Anthonisen criteria requires oral prednisolone 30mg daily plus amoxicillin 500mg TDS to address both inflammatory and infective components.",
    learningObjectives: [
