...
export const EXPANDED_QUESTION_BANK: GMCQuestion[] = [
  // CARDIOVASCULAR MEDICINE - GMC MLA Compliant Questions
  {
    ...
    correctAnswer: 0,
    explanation: "This 58-year-old diabetic patient presents with classic inferior STEMI evidenced by ST elevation in leads II, III, aVF, indicating acute occlusion of the right coronary artery. The 90-minute symptom duration places him within the critical window for primary percutaneous coronary intervention (PCI). Option A is definitively correct as it provides the evidence-based dual antiplatelet therapy combined with primary PCI, representing the gold standard of care according to ESC STEMI Guidelines 2023 and NICE CG167.\n\nAspirin 300mg loading dose must be chewed for rapid buccal absorption, achieving >95% cyclooxygenase-1 inhibition within 30 minutes, irreversibly blocking thromboxane A2 synthesis and platelet aggregation. Clopidogrel 600mg loading dose provides additional P2Y12 receptor blockade, achieving maximum platelet inhibition within 2-6 hours, with studies showing 20% reduction in cardiovascular events when combined with aspirin in acute coronary syndromes.\n\nPrimary PCI is superior to thrombolysis when available within 120 minutes of first medical contact, achieving TIMI-3 flow in >95% of cases versus 60% with fibrinolytic therapy. The DANAMI-2 trial demonstrated 40% reduction in death, reinfarction, and stroke with primary PCI versus thrombolysis. Door-to-balloon time should be <90 minutes for optimal outcomes.\n\nOption B (thrombolysis) is inferior when PCI is readily available and carries higher bleeding risk. Option C (IV morphine and GTN) lacks reperfusion therapy. Option D (high-flow oxygen) doesn't address the underlying coronary occlusion. Option E (echocardiogram) delays definitive treatment.\n\nThe patient's diabetes mellitus increases cardiovascular risk, making urgent intervention crucial for preventing complications and preserving myocardial function.\n\nConcise Summary: Inferior STEMI requires immediate dual antiplatelet therapy (aspirin 300mg + clopidogrel 600mg) plus primary PCI within 120 minutes for optimal reperfusion and mortality reduction.",
    learningObjectives: [
...

  {
    ...
    correctAnswer: 1,
    explanation: "This 62-year-old patient presents six weeks post-myocardial infarction with classic heart failure with reduced ejection fraction (HFrEF) evidenced by breathlessness on minimal exertion, bilateral ankle swelling, and severely impaired left ventricular function (EF 35%). The markedly elevated BNP at 850 pg/ml (normal <100 pg/ml) confirms the diagnosis and indicates significant neurohormonal activation requiring immediate guideline-directed medical therapy.\n\nOption B is definitively correct as it provides the foundational dual neurohormonal blockade with ACE inhibitor and beta-blocker, which represents the cornerstone of evidence-based HFrEF management according to NICE CG108 and ESC Heart Failure Guidelines 2021. This combination has the strongest evidence base for mortality reduction in post-MI heart failure.\n\nRamipril should be initiated at 1.25mg daily and carefully titrated to maximum tolerated dose (10mg daily) over 2-4 weeks, monitoring renal function and potassium levels. The landmark SAVE trial demonstrated 19% mortality reduction with captopril post-MI, while AIRE and TRACE trials confirmed similar benefits with ramipril and trandolapril respectively. ACE inhibitors block the renin-angiotensin-aldosterone system, reducing afterload, preload, and ventricular remodeling.\n\nBisoprolol should be introduced once the patient is stabilized on ACE inhibitor therapy, starting at 1.25mg daily and titrating to 10mg daily. The CIBIS-II trial specifically demonstrated 34% mortality reduction with bisoprolol in HFrEF patients. Beta-blockers counteract sympathetic nervous system activation, reducing heart rate, myocardial oxygen demand, and arrhythmic risk.\n\nOption A (furosemide alone) provides symptomatic relief but no mortality benefit. Option C (statins/aspirin) addresses secondary prevention but not the heart failure syndrome. Option D (amlodipine/bendroflumethiazide) can worsen heart failure through negative inotropic effects. Option E delays evidence-based therapy.\n\nConcise Summary: Post-MI HFrEF with EF 35% requires immediate dual neurohormonal blockade with ramipril and bisoprolol for proven mortality reduction and symptom improvement.",
    learningObjectives: [
  ...
  // RESPIRATORY MEDICINE - GMC MLA Compliant Questions
  {
    ...
    correctAnswer: 1,
    explanation: "This 72-year-old diabetic patient presents with severe community-acquired pneumonia characterized by productive cough with purulent sputum, fever, confusion, and significant physiological compromise. Systematic assessment using CURB-65 severity scoring is essential for appropriate management decisions.\n\nOption B is definitively correct as the CURB-65 score is 3-4, indicating severe pneumonia requiring hospital admission with ITU consideration. CURB-65 components for this patient: Confusion (1 point - altered mental state noted), Urea elevation (1 point - highly likely given diabetes, age, and dehydration), Respiratory rate ≥30/min (0 points - currently 28/min but trending upward), Blood pressure <90mmHg systolic (1 point - hypotensive at 100/65mmHg suggesting sepsis), age ≥65 years (1 point). Total score 3-4 indicates severe pneumonia with mortality risk of 15-40%.\n\nBTS Guidelines for Community Acquired Pneumonia 2015 and NICE CG191 explicitly recommend ITU consideration for CURB-65 ≥3, as these patients require close monitoring and potential organ support. This patient requires immediate IV co-amoxiclav 1.2g TDS providing broad-spectrum coverage against typical pathogens (Streptococcus pneumoniae, Haemophilus influenzae) and atypical organisms (Mycoplasma, Legionella). The beta-lactamase inhibitor component (clavulanic acid) ensures efficacy against resistant strains.\n\nOxygen saturation 88% indicates type 1 respiratory failure requiring immediate supplemental oxygen targeting 94-98% saturation. The combination of hemodynamic instability (hypotension), hypoxemia, and altered mental state mandates ITU assessment for potential non-invasive ventilation, vasopressor support, or intubation.\n\nOption A (discharge) is contraindicated for severe pneumonia. Option C (oral antibiotics) is inadequate for severe disease requiring IV therapy. Option D (score 1) dangerously underestimates severity. Option E (score 5) is mathematically impossible. Diabetes mellitus increases infection risk and complication rates, making aggressive management crucial.\n\nConcise Summary: CURB-65 score 3-4 indicates severe pneumonia requiring immediate hospital admission, ITU consideration, IV co-amoxiclav, and respiratory support for optimal outcomes.",
    learningObjectives: [
...

  {
    ...
    correctAnswer: 2,
    explanation: "This 68-year-old patient with established COPD presents with acute exacerbation characterized by increased breathlessness, increased sputum volume, and crucially, purulent sputum production indicating bacterial superinfection. This clinical presentation meets all three Anthonisen criteria for antibiotic therapy, requiring immediate evidence-based management.\n\nOption C is definitively correct as it provides the dual therapeutic approach of oral corticosteroid and antibiotic therapy, which represents the gold standard management for COPD exacerbation with purulent sputum according to NICE CG101 and GOLD 2023 guidelines.\n\nThe patient meets all three Anthonisen criteria: (1) increased dyspnea from baseline, (2) increased sputum volume, and (3) increased sputum purulence. This triad indicates bacterial infection requiring antibiotic therapy. Studies demonstrate that patients meeting all three criteria have 70% bacterial isolation rates compared to 29% when only one criterion is present.\n\nPrednisolone 30mg daily for 5 days reduces airway inflammation, shortens recovery time by 1-2 days, and improves lung function. The landmark Niewoehner study demonstrated 50% reduction in treatment failure rates with systemic corticosteroids. Prednisolone specifically reduces neutrophilic airway inflammation and decreases hospital length of stay by an average of 1.22 days.\n\nAmoxicillin 500mg TDS for 5 days provides targeted coverage against common COPD pathogens: Haemophilus influenzae (40-50% of exacerbations), Streptococcus pneumoniae (25-30%), and Moraxella catarrhalis (15-20%). The beta-lactam mechanism disrupts bacterial cell wall synthesis, providing bactericidal activity against these gram-positive and gram-negative organisms.\n\nOption A (high-flow oxygen) risks dangerous CO2 retention in COPD patients due to loss of hypoxic drive. Option B (IV hydrocortisone) is indicated for severe asthma exacerbation, not COPD. Option D (bronchodilators alone) inadequately addresses the bacterial component. Option E (NIV) is premature without arterial blood gas assessment.\n\nConcise Summary: COPD exacerbation meeting all three Anthonisen criteria requires dual therapy with prednisolone 30mg daily and amoxicillin 500mg TDS for optimal clinical outcomes.",
    learningObjectives: [
